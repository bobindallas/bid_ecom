...
@section('content_header')
	{{-- Breadcrumbs::render('product_option_images.edit', $product_option) --}}
@stop

@section('content')
<div class="container">
			<div id="plist">
			<form action="{{ route('product_option_images.update', [$product_option->id, $image->id]) }}" name="F1" id="F1" enctype="multipart/form-data" method="POST">
				@csrf
				@method('PUT')
				<div class="card">
			...
			<input type="hidden" name="product_option_id" id="product_option_id" value="{{ $product_option->product->id }}">
