...
@section('content_header')
	{{ Breadcrumbs::render('product_options.create', $product) }}
@stop
...
@section('content')
	<div class="container">
		<div id="plist">
		<div class="card">
			<div class="card-header">Add New Product Option</div>
			<div class="card-body">
				<form method='POST' action="{{ route('product_options.store', $product) }}" name="F1" id="F1">
					@csrf
					@method('POST')
					...
					<div class="form-group">
						...
						<input type="text" name="name" value="" class='form-control' v-model="fdata.name" v-on:keyup="check_form" placeholder='Product Option Name'>
					</div>
					<div class="form-group">
