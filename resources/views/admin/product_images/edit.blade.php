...
@section('content_header')
	{{ Breadcrumbs::render('product_images.edit', $product) }}
@stop

@section('content')
<div class="container">
			<div id="plist">
			<form action="{{ route('product_images.update', [$product->id, $image->id]) }}" name="F1" id="F1" enctype="multipart/form-data" method="POST">
				@csrf
				@method('PUT')
				<div class="card">
