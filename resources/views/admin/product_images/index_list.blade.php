...
@section('title', 'Product Images')
	...
	@section('content_header')
		{{ Breadcrumbs::render('product_images.index_list', $product) }}
	@stop
...
<a href="{{ route('product_images.index_grid', $product->id ) }}" title="Grid View"><i class="fa fa-th fa-2x" style="color: #ccc;"></i></a>
