...
@section('title', 'Edit Product Option Image')

@section('content_header')
	{{ Breadcrumbs::render('product_option_item_images.edit', $product_option_item) }}
@stop

@section('content')
<div class="container">
			<div id="plist">
			<form action="{{ route('product_option_item_images.update', [$product_option_item->id, $image->id]) }}" name="F1" id="F1" enctype="multipart/form-data" method="POST">
				@csrf
				@method('PUT')
				<div class="card">
				<div class="panel panel-primary">
					<div class="card-header">Update Product Option Image</div>
					<div class="card-body">
			...
			<input type="hidden" name="product_option_id" id="product_option_id" value="{{ $product_option_item->product_option->product->id }}">
			<input type="hidden" name="product_option_image_id" id="product_option_image_id" value="{{ $image->id }}">
