...
@section('content')
	<div class="container">
		...
		<div class="card">
			...
			<div class="card-body">
				<form method='POST' action="{{ route('store_details.store') }}" name="F1" id="F1">
					@csrf
					@method('POST')
					...
					<div class="form-group">
						...
						<input type="checkbox" id="enable_shipping" name="enable_shipping" value="1" v-model="fdata.enable_taxes">
					</div>
